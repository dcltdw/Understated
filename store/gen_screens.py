...
THEMES = [
    ...
    ("3-purple",        0x800080, 0x00FFFF, 0xFFFFFF, 0xFFFFFF, 0x00AAFF),
    ("4-red",           0xFF0000, 0xFFFF00, 0xFFFFFF, 0xFFFFFF, 0x00FF00),
    ("5-yellow",        0xC8A415, 0x000000, 0x000000, 0x000000, 0xFF0000),
    ("6-black_gold",    0x000000, 0xFFFF00, 0xFFFFFF, 0xFFFFFF, 0xFFAAFF),
    ("7-black_silver",  0x000000, 0xC0C0C0, 0xFFFFFF, 0xFFFFFF, 0xFF5500),
]
